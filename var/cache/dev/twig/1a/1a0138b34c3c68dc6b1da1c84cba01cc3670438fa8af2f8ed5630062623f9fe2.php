...
class __TwigTemplate_4a749341189c6479c0be76f3d5be9ab65c4d26ed75e125652b6d0df578359676 extends Template
{
    private $source;
    private $macros = [];
...
{% endblock %}
    ...
    <!-- Custom Js -->
    <script src=\"{{asset('js/custom-scripts.js')}}\"></script>{% endblock %}", "test/login.html.twig", "C:\\workspace\\tp2template\\templates\\test\\login.html.twig");
    }
}
