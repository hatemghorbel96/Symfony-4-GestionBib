...
class __TwigTemplate_f61ec2ffb852a7eb20fe43eb4adfdf101a8fe6310c535abc4a4a5b057c53d80d extends Template
{
    private $source;
    private $macros = [];
...
<?php if (\$form_method !== \$method): ?>
    <input type=\"hidden\" name=\"_method\" value=\"<?php echo \$view->escape(\$method) ?>\" />
<?php endif ?>
", "@Framework/Form/form_start.html.php", "C:\\workspace\\tp2template\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_start.html.php");
    }
}
