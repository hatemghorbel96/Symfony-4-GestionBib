...
class __TwigTemplate_4f11742031d1c02afba27189b99a642b46558ae205943ce74b266bca3fe0581e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1> <i class=\"fa fa-lock\"> Inscription sur le site</i></h1>
    <hr>
    ";
        // line 8
    ...
    ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Répétez votre mot de passe", "attr" => ["placeholder" => "Répétez votre mot de passe..."]]);
        echo "
   <hr>
...
{% block body %}
    <h1> <i class=\"fa fa-lock\"> Inscription sur le site</i></h1>
    <hr>
    {{ form_start(form) }}
...
{% endblock %}", "test/index.html.twig", "E:\\symfony_projects\\tp2template\\templates\\test\\index.html.twig");
    }
}
